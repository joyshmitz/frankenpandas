//! Column::isin over a 5M Int64 column vs a small bounded needle set. bench_isin <n>
...
fn main() {
    ...
    println!("isin i64 n={n}: best={best}ns ({:.2}ms)", best as f64 / 1e6);
}
