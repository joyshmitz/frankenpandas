...
fn mks(n: usize, off: i64, seed: u64, withnull: bool) -> Series {
...
fn main() {
    ...
    let b = mks(n, 500_000, 2, false);
    timeit("Series.combine_first unaligned (1M)", || {
        std::hint::black_box(a.combine_first(&b).unwrap());
    });
}
