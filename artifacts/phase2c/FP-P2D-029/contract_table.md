...
| error_contract | invalid `concat_join`, duplicate output columns, and duplicate input index labels fail closed |
...
| excluded_scope | axis=0 outer union-column semantics, MultiIndex concat, duplicate-column-preserving output model |
